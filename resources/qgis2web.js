...
map.getView().fit([8067555.514696, 3801287.493241, 8658582.662275, 4245709.205512], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapping the Bias: Kashmir Conflict</h2>';
        return titleElement;
    })(),
